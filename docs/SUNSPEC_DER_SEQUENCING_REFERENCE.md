...
**What we skip:** Phase 2 (reversion safety — WSetRvrtTms was deemed "non-functional" but this conclusion may be invalid due to improper sequencing).
...
|----------|------------|-------------|:---------------:|
| WSetRvrtTms (327) | "Non-functional" | Rapid write | ✅ YES |
| WSetRvrtRem (329) | "Never counts down" | Read after rapid write | ✅ YES |
| ControllerHb | "Silently ignored" | Rapid write | ✅ YES |

...
- [HARDWARE_TEST_GUIDE.md](HARDWARE_TEST_GUIDE.md) — Hardware test procedures
- [TEST_QUICK_REFERENCE.md](TEST_QUICK_REFERENCE.md) — Quick test reference

## Active Planning
- [CONFLICT_DETECTION_ANALYSIS.md](CONFLICT_DETECTION_ANALYSIS.md) — Phase 3 design decision

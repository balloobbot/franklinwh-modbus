...
# The counts are this firmware's (V10R01B04D00), confirmed against an aGate X in
# https://github.com/david2069/franklinwh-modbus/issues/12; a device reporting
# others fails SunSpecComponent's header check on the first read, since a curve
# model's length is a function of them.
